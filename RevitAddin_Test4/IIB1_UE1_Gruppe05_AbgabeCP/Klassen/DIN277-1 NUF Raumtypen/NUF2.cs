...
namespace IIB1_UE1_Gruppe05_AbgabeCP.Klassen.DIN277_1_NUF_Raumtypen
{
    ...
    class NUF2 : Raum
    {
        ...
        public NUF2(string id, string bez, string typ, string nutzungsart, double flaeche, int plaetze, bool mietzustand) : base(id, bez, typ, nutzungsart, flaeche, mietzustand)
        {
